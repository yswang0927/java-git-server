...
public class JnaUtils {
     ...
     *
     * @param file File/directory to set the permission bits for.
     * @param mode A mode created from or'd permission bit masks S_I*
     ...
     * function of the native C library. See 'man 2 chmod' for more information.
     *
     * @param path Path to a file/directory to set the permission bits for.
     * @param mode A mode created from or'd permission bit masks S_I*
     * @return Upon successful completion, a value of 0 returned. Otherwise, a value of -1 is returned.
     */
     ...
     * 'lstat' on a file.
     *
     * @param path File/directory to get the file mode from.
     ...
     * 'lstat' on a file.
     *
     * @param path Path to a file/directory to get the file mode from.
     * @return Upon successful completion, the file mode bits are returned. Otherwise, a value of -1 is returned.
     */
     ...
     *
     * @param path File/directory to get the file status from.
     ...
     * information for a file. Currently this is the file mode, the user id and group id of the owner.
     *
     * @param path Path to a file/directory to get the file status from.
     * @return Upon successful completion, a Filestat object containing the file information is returned.
     * Otherwise, null is returned.
     */
     ...
     *
     * @param path Path to a single file or directory.

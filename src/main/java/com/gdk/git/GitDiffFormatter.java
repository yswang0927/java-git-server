...
import com.gdk.git.DiffUtils.BinaryDiffHandler;
...
public class GitDiffFormatter extends DiffFormatter {
	 ...
	 * otherwise we'd just have re-implemented {@link GitDiffFormatter#format(DiffEntry) format(DiffEntry)}
	...
	private static class DiffOutputStream extends ResettableByteArrayOutputStream {
		...
		private GitDiffFormatter formatter;
		private BinaryDiffHandler binaryDiffHandler;

		public void setFormatter(GitDiffFormatter formatter, BinaryDiffHandler handler) {
	...
	public GitDiffFormatter(String commitId, Repository repository, String path, BinaryDiffHandler handler, int tabLength) {

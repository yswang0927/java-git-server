...
public interface IRepositoryManager {
     ...
     * @since 1.4.0
     */
    void updateRepositoryModel(String repositoryName, RepositoryModel repository, boolean isCreate) throws GitException;
     ...
     *
     * @param repository if null only the globally specified scripts are returned
     ...
     * .groovy extension
     *
     * @param repository optional parameter
     * @return list of available hook scripts
     * @since 1.4.0
     */

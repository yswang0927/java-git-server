...
public class GarbageCollectorService implements Runnable {
    ...
    public GarbageCollectorService(GitStoreSettings settings, IRepositoryManager repositoryManager) {
    ...
    public boolean isReady() {
        return settings.isEnableGarbageCollection();
    }
    ...
    public void run() {
        ...
        for (String repositoryName : repositoryManager.getRepositoryList()) {
            ...
            try {
                ...
                long gcThreshold = GitFileUtils.convertSizeToLong(model.gcThreshold, 500 * 1024L);
